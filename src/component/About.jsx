            ...
            <div className='container mx-auto px-20 '>
                <div className='grid grid-cols-3 content-center mt-12'>
                    ...
                    <div className='col-span-2 text-color3 mt-12 space-y-6'>
                        ...
                        <div className='pt-5'>
                            <a href="#" target="_blank" className='text-lg text-color3 font-medium px-6 py-2 border-2 border-color3 rounded-md hover:text-white hover:bg-color3 hover:duration-75'>Hired Me</a>
                        </div>
                    </div>
                </div>
            </div>
