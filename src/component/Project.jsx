        ...
        <div className='h-screen bg-color1'>
            ...
            <div className='container mx-auto px-12 mt-6'>
                <ul className='flex justify-center text-lg space-x-16 text-indigo-300'>
                    ...
                    <li className='hover:text-color3'><button>Bootstrap</button></li>
                    <li className='hover:text-color3'><button>JavaScript</button></li>
                    <li className='hover:text-color3'><button>React</button></li>
                    <li className='hover:text-color3'><button>Node</button></li>
                </ul>
                <div className='grid grid-cols-3 gap-x-4 gap-y-7 mt-10'>
                    {
                        item.map((items)=>{
                            const { images,category, codelink, livelink} = items;
                            return(
                                <div className='relative group'>
                                    ...
                                    <div className='absolute top-16 w-full py-10 bg-color2 text-center space-x-8 hidden group-hover:block'>
                                        <a href="">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 p-1 inline-block stroke-slate-400 border border-slate-400 rounded-full hover:stroke-color3 hover:border-color3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
